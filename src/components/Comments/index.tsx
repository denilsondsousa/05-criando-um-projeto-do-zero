// Credits to: https://www.gregorygaines.com/blog/posts/2020/11/21/how-to-integrate-utterances-in-react-with-reloading-comments
...
const Comments = (): JSX.Element => {
  const repo = 'denilsondsousa/05-criando-um-projeto-do-zero';
